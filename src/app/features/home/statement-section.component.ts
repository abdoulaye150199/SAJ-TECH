...
@Component({
  ...
  template: `
    <section class="statement" appReveal>
      ...
      <div class="statement-copy"><h1>STUDIO DIGITAL À DAKAR<br />ET MONTRÉAL.<br /><em>DES EXPÉRIENCES QUI COMPTENT.</em></h1><div><p>SAJ Tech réunit design, développement et stratégie pour créer des expériences web et mobiles utiles, singulières et mémorables.</p><button class="arrow-link" (click)="navigate.emit('services')">Notre savoir-faire <span>↗</span></button></div></div>
